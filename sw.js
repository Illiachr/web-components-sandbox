...
const ASSETS_TO_CACHE = [
  ...
  '/js/src/db/db.manager.js',
  '/js/vendor/db.worker.js',
  '/js/vendor/sqlite3-opfs-async-proxy.js',
  '/js/vendor/sqlite3-worker1-bundler-friendly.mjs',
  '/js/vendor/sqlite3-worker1-promiser-bundler-friendly.mjs',
  '/js/vendor/sqlite3-worker1-promiser.js',
  '/js/vendor/sqlite3-worker1-promiser.mjs',
  '/js/vendor/sqlite3-worker1.js',
  '/js/vendor/sqlite3-worker1.mjs',
  '/js/vendor/sqlite3.js',
